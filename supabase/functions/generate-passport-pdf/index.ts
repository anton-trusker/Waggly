...
const COLORS = {
    PRIMARY: rgb(0.17, 0.04, 0.5),   // #2C097F Pawzly Purple
    ACCENT: rgb(0.06, 0.73, 0.51),    // #10b981 Pawzly Green
...
serve(async (req) => {
    ...
    try {
        ...
        page.drawText("Generated by Pawzly - Your Trusted Pet Care Partner", {
            x: margin + 80,
            y: currentY - 40,
            size: 10,
            font: font,
        ...
        try {
            const qrUrl = `https://mypawzly.com/p/verify/${pet.passport_id}`;
        ...
        page.drawText("Pawzly Inc. | www.mypawzly.com | Secure Pet Travel & Health Records", { x: margin, y: 55, size: 8, font: font, color: COLORS.PRIMARY });
