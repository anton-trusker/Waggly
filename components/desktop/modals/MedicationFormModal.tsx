...
export default function MedicationFormModal({ visible, onClose, petId, onSuccess }: MedicationFormModalProps) {
                ...
                <View style={styles.modal}>
                    ...
                    <ScrollView style={styles.form} showsVerticalScrollIndicator={false}>
                                ...
                                <View style={styles.select}>
                                    {DOSAGE_UNITS.map((unit) => (
                                        <TouchableOpacity
                                            ...
                                            style={[
                                                styles.selectOption,
                                                formData.dosage_unit === unit && styles.selectOptionActive,
                                            ]}
                            ...
                            <View style={styles.chipContainer}>
                                {FREQUENCIES.map((freq) => (
                                    <TouchableOpacity
                                        ...
                                        style={[
                                            styles.chip,
                                            formData.frequency === freq && styles.chipActive,
                                        ]}
                                    ...
                                    >
                                        <Text
                                            style={[
                                                styles.chipText,
                                                formData.frequency === freq && styles.chipTextActive,
                                            ]}
                                        >
                                            {freq}
                                        </Text>
                        ...
                        <TouchableOpacity
                            ...
                            onPress={() =>
                                setFormData({ ...formData, reminders_enabled: !formData.reminders_enabled })
                            }
                        >
                            ...
                            <View style={[styles.switch, formData.reminders_enabled && styles.switchActive]}>
                                <View
                                    style={[
                                        styles.switchThumb,
                                        formData.reminders_enabled && styles.switchThumbActive,
                                    ]}
                                />
                            </View>
                        </TouchableOpacity>
                                        ...
                                        >
                                            <Text
                                                style={[
                                                    ...
                                                    formData.currency === curr && styles.currencyButtonTextActive,
                                                ]}
                                            >
                                                {curr}
                                            </Text>
